...
console.log(`
  3 informações sobre o array randomValues:
    - As primeiras 4 strings são ${randomValues.slice(0, iteracoes).filter(item => typeof item === 'string').join(', ')};
    - Até que as primeiras 4 strings fossem iteradas, ${strings} booleans foram iterados;
...
*/
const tipoBebida = "refrigerante"; // Você pode alterar para testar diferentes tipos de bebidas
